...
/// Note: `id` are String for more flexibility accross entity types
#[derive(Deserialize)]
...
// region:    --- Space Scoped Params

/// Generic Spaced Params structure for any RPC Create call.
#[derive(Deserialize)]
pub struct SpacedParams<D> {
	pub space_id: i64,
	pub data: Option<D>,
}
impl<D> IntoParams for SpacedParams<D> where D: DeserializeOwned + Send {}

// endregion: --- Space Scoped Params
